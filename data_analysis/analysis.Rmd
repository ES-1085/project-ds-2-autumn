...
## Yearly Observations
Let's look at the yearly observations for the sea otters. As can be shown below, there is a gap in data collection starting from the year 1970 through 1985. This will need to be accounted for if there is any analysis on temporal differences. 
