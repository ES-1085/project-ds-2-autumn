...
andreanof_islands, western_alaskan_peninsula, southern_southeast_alaska, northern_southeast_alaska, eastern_alaskan_peninsula, kachemak_bay, western_prince_william_sound
...
seot_pws_wa %>% 
  filter(FINAL_AGE > -1) %>% 
  ggplot(data = seot_pws_wa, mapping = aes(x = WEIGHT, y = FINAL_AGE, color = FINAL_AGE)) + 
  geom_jitter() +
